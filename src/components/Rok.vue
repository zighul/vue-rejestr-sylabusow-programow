        ...
        <div class="q-pa-md q-gutter-sm">
          <q-breadcrumbs>
            ...
            <q-breadcrumbs-el
              ...
              "
            />
            <q-breadcrumbs-el :label="lastPart[7]" />
          </q-breadcrumbs>
        </div>
        ...
        <div v-if="options" class="row justify-center">
          <div style="min-width: 200px">
            <q-select
              ...
              v-model="rok"
              :options="options"
              :label="language === 'pl' ? 'Rok studiów' : 'Year of studies'"
              class="q-mb-md"
            />
          </div>
        </div>
